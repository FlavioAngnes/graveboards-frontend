export interface BeatmapsetListingSorting {
    value: BeatmapsetListingSortingOptions;
    order: 'asc' | 'desc';
}

export type BeatmapsetListingSortingOptions =
...
/*
export const BeatmapsetListingSortingOptions = {
    Profile: {
...
export type BeatmapsetListingSortingOptions = typeof BeatmapsetListingSortingOptions[keyof typeof BeatmapsetListingSortingOptions];
 */
