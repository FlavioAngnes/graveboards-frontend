...
const SelectRequestStatus: FC<SelectRequestStatusProps> = ({initialStatus}) => {
...
interface SelectRequestStatusItemProps {
    ...
    selectStatus: (status:  "pending" | "accepted" | "rejected") => void;
    selected: boolean;
}

const SelectStatusRequestItem: FC<SelectRequestStatusItemProps> = ({status, selectStatus, selected}) => {
    return (
        <button
            type="button"
            className={
